...
function process_file() {
  ...
  TEMPLATE="${TEMPLATE//zzzLOG_FILEzzz/$LOG_FILE}"
  TEMPLATE="${TEMPLATE//zzzDB_URIzzz/$METASTORE_DB_URI}"
  TEMPLATE="${TEMPLATE//zzzDB_USERNAMEzzz/$METASTORE_DB_USERNAME}"
  TEMPLATE="${TEMPLATE//zzzDB_PASSWORDzzz/$METASTORE_DB_PASSWORD}"
